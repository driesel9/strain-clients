...
$.fn.myfunc = function (userPref) {
  ...
  this.defaultProperty = {
    ...
    initDeg             : -40,         /**reading begins angle*/
    maxDeg              : 260,         /**total angle of the meter reading*/
    ...
    numbW               : 23,          /**indicator number width*/
    numbH               : 20,          /**indicator number height*/
    midNobW             : 20,          /**indicator mid nob width*/
  ...
  this.changePosition = function (){
    ...
    self.parentElem.find(".speedPosition").html("<span class='valueg'>" +centerVal + "</span><br /><span class='label-tag'>" + self.defaultProperty.gagueLabel + "</span>" );
